      ...
      <div class="service-block">
        ...
        <div class="text">
          ...
          <div class="text-bottom">
            <p>Sub Services: Google Analytics Integration, Search Console Setup, Yoast Plugin Setup, Keyword Research & Strategy, Competitor Analysis, Content Writing, Backlink Management</p>
          </div>
