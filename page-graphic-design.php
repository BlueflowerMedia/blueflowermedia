    ...
    <div class="design-item-row">
      ...
      <div class="design-item">
        ...
        <div class="item-text">
          ...
          <p>A Brand style guide is a booklet that contains design guidelines to follow for your business. It includes rules for color palettes, typography hierarchy, imagery, iconography, and more. </p>
        </div>
      </div>
    ...
    <div class="design-item-row">
      ...
      <div class="design-item">
        ...
        <div class="item-text">
          ...
          <p>Feel free to talk to us about your other design needs. We would love to help!</p>
        </div>
      </div>
